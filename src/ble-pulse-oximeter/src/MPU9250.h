/*
MPU9250.h - Header file for the MPU9250 Triple Axis Gyroscope & Accelerometer Arduino Library.
...
#define MPU9250_ADDRESS             (0x68) // 0x69 when AD0 pin to Vcc
...
#define MPU9250_REG_FF_THRESHOLD      (0x1D)
#define MPU9250_REG_FF_DURATION       (0x1E)
#define MPU9250_REG_MOT_THRESHOLD     (0x1F)
#define MPU9250_REG_MOT_DURATION      (0x20)
#define MPU9250_REG_ZMOT_THRESHOLD    (0x21)
#define MPU9250_REG_ZMOT_DURATION     (0x22)
#define MPU9250_REG_INT_PIN_CFG       (0x37) // INT Pin. Bypass Enable Configuration
#define MPU9250_REG_INT_ENABLE        (0x38) // INT Enable
...
typedef enum {
    MPU9250_CLOCK_KEEP_RESET      = 0b111,
    MPU9250_CLOCK_EXTERNAL_19MHZ  = 0b101,
    MPU9250_CLOCK_EXTERNAL_32KHZ  = 0b100,
    MPU9250_CLOCK_PLL_ZGYRO       = 0b011,
    MPU9250_CLOCK_PLL_YGYRO       = 0b010,
    MPU9250_CLOCK_PLL_XGYRO       = 0b001,
    MPU9250_CLOCK_INTERNAL_8MHZ   = 0b000
} MPU9250_clockSource_t;

typedef enum {
    MPU9250_SCALE_2000DPS         = 0b11,
    MPU9250_SCALE_1000DPS         = 0b10,
    MPU9250_SCALE_500DPS          = 0b01,
    MPU9250_SCALE_250DPS          = 0b00
} MPU9250_dps_t;

typedef enum {
    MPU9250_RANGE_16G             = 0b11,
    MPU9250_RANGE_8G              = 0b10,
    MPU9250_RANGE_4G              = 0b01,
    MPU9250_RANGE_2G              = 0b00,
} MPU9250_range_t;

typedef enum {
    MPU9250_DELAY_3MS             = 0b11,
    MPU9250_DELAY_2MS             = 0b10,
    MPU9250_DELAY_1MS             = 0b01,
    MPU9250_NO_DELAY              = 0b00,
} MPU9250_onDelay_t;

typedef enum {
    MPU9250_DHPF_HOLD             = 0b111,
    MPU9250_DHPF_0_63HZ           = 0b100,
    MPU9250_DHPF_1_25HZ           = 0b011,
    MPU9250_DHPF_2_5HZ            = 0b010,
    MPU9250_DHPF_5HZ              = 0b001,
    MPU9250_DHPF_RESET            = 0b000,
} MPU9250_dhpf_t;

typedef enum {
    MPU9250_DLPF_6                = 0b110,
    MPU9250_DLPF_5                = 0b101,
    MPU9250_DLPF_4                = 0b100,
    MPU9250_DLPF_3                = 0b011,
    MPU9250_DLPF_2                = 0b010,
    MPU9250_DLPF_1                = 0b001,
    MPU9250_DLPF_0                = 0b000,
} MPU9250_dlpf_t;
...
public:
    ...
    bool begin(MPU9250_dps_t scale = MPU9250_SCALE_2000DPS, MPU9250_range_t range = MPU9250_RANGE_2G, int mpua = MPU9250_ADDRESS);
    void setClockSource(MPU9250_clockSource_t source);
    void setScale(MPU9250_dps_t scale);
    void setRange(MPU9250_range_t range);
    MPU9250_clockSource_t getClockSource(void);
    MPU9250_dps_t getScale(void);
    MPU9250_range_t getRange(void);
    void setDHPFMode(MPU9250_dhpf_t dhpf);
    void setDLPFMode(MPU9250_dlpf_t dlpf);
    MPU9250_onDelay_t getAccelPowerOnDelay();
    void setAccelPowerOnDelay(MPU9250_onDelay_t delay);
